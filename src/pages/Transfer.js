...
{/* FIX: Changed maxWidth 540 to width 100% to close the gap */}
...
{step === 1 && (
<div className="glass-card" style={{ padding: 32 }}> {/* FIX: Changed padding 10 -> 32 to match pic 2 */}
...
display: 'block',
fontSize: 12,
color: 'var(--text-secondary)', // FIX: You had var(–text-secondary) with a wrong dash
marginBottom: 8,
